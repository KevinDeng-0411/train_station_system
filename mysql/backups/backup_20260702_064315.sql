...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='退票记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `refund_records` VALUES (1,9,88.00,'2026-07-02 06:26:35',3,'乘客行程变更','2026-07-02 06:26:35'),(2,16,184.00,'2026-07-01 22:34:58',1,'test',NULL);
...
CREATE TABLE `salespeople` (
  ...
  KEY `idx_status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='业务员信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stations` (
  ...
  KEY `idx_city` (`city`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='站点信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `stations` VALUES (1,'北京南站','北京','2026-07-02 06:26:35'),(2,'天津南站','天津','2026-07-02 06:26:35'),(3,'济南西站','济南','2026-07-02 06:26:35'),(4,'南京南站','南京','2026-07-02 06:26:35'),(5,'无锡东站','无锡','2026-07-02 06:26:35'),(6,'上海虹桥站','上海','2026-07-02 06:26:35'),(7,'广州南站','广州',NULL),(8,'测试站','测试城市',NULL),(9,'测试站1','测试城市1','2026-07-01 22:42:52');
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='车票销售记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `trains` (
  ...
  KEY `idx_status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='车次信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-07-02  6:43:15
